...
export default function Home() {
  return (
    <div className="relative isolate min-h-screen overflow-hidden bg-[#060b16] px-4 py-8 text-[#f4f8ff]">
      ...
      <main className="relative z-10 mx-auto grid w-full max-w-230 gap-6">
        <ConnectionHeader />
        <WalletPanel />
      </main>
    </div>
